...
export const initMap = (element, mapInfo, viewPlayerInventory) => {
    // ===============================================================================================
    ...
    layerControl.addOverlay(getHistoryPlayersLayer(map, mapInfo, viewPlayerInventory), i18n.global.t('views.map.historyPlayer') + ' (<span id="mapControlOfflinePlayerCount">0</span>)');
    layerControl.addOverlay(getOnlinePlayersLayer(map, mapInfo, viewPlayerInventory), i18n.global.t('views.map.onlinePlayer') + ' (<span id="mapControlOnlinePlayerCount">0</span>)');
